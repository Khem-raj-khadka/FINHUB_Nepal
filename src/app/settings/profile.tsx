      ...
      switch (cat) {
        case "emergency":
          return {
            ...
            reason: isLow
              ? "तपाईंको आपतकालीन बचत सिफारिस गरिएको लक्ष्य भन्दा कम छ।"
              : "तपाईंसँग बलियो आपतकालीन बचत कोष छ।",
        ...
        case "savings":
          return {
            ...
            reason: isLow
              ? "तपाईंको मासिक बचत दर लक्ष्य गरिएको ३०% भन्दा कम छ।"
              : "तपाईंको बचत गर्ने दर उत्कृष्ट छ।",
        ...
        case "investment":
          return {
            ...
            reason: isLow
              ? "तपाईंको नियमित लगानी वा सक्रिय SIP को दर कम छ।"
              : "तपाईं लगातार नियमित लगानी गर्दै हुनुहुन्छ।",
        ...
        case "debt":
          return {
            ...
            reason: isLow
              ? "तपाईंको सम्पत्तिको तुलनामा ऋणको मात्रा बढी छ।"
              : "तपाईंको ऋण नियन्त्रणमा छ।",
        ...
        default:
          return {
            ...
            reason: isLow
              ? "तपाईंको आम्दानीको ७०% भन्दा बढी खर्च भइरहेको छ।"
              : "तपाईंले आफ्नो खर्च राम्ररी नियन्त्रण गर्नुभएको छ।",
      ...
      switch (cat) {
        case "emergency":
          return {
            ...
            reason: isLow
              ? "Your emergency savings cover less than your recommended target."
              : "You have a healthy emergency fund reserve.",
        ...
        case "savings":
          return {
            title: "Savings Habit",
            reason: isLow
              ? "Your monthly savings rate is below the target 30% rule."
              : "You are maintaining a strong monthly savings habit.",
        ...
        case "investment":
          return {
            ...
            reason: isLow
              ? "Your recurring investments or active SIP frequency is low."
              : "You are consistently investing and building wealth.",
        ...
        case "debt":
          return {
            ...
            reason: isLow
              ? "Your debt-to-asset ratio is higher than the recommended limit."
              : "Your outstanding liabilities are well-managed.",
        ...
        default:
          return {
            ...
            reason: isLow
              ? "Your expense-to-income ratio exceeds 70% of earnings."
              : "Your discretionary spending is well-controlled.",
  ...
  const categories = [
    {
      ...
      score: financialScore.emergencyScore,
    },
    {
      key: "savings",
      label: "Savings Habit",
      score: financialScore.savingsScore,
    },
    {
      key: "investment",
      label: "Investment Consistency",
      score: financialScore.investmentScore,
    },
    { key: "debt", label: "Debt Management", score: financialScore.debtScore },
    {
      key: "spending",
      label: "Spending Control",
      score: financialScore.spendingScore,
    },
  ];
                  ...
                  {isExpanded && (
                    ...
                    >
                      ...
                      <View style={styles.tipRow}>
                        <Text
                          style={[styles.tipTitle, { color: colors.accent }]}
                        >
